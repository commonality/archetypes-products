...
-   [1. Overview](#1-overview)
    -   [1.1. The **@archetypes/product** Node.js module](#11-the-archetypes-productssignatures-nodejs-module)
...
-   [3. Installing archetypes-products](#3-installing-archetypes-productssignatures)
...
### 1.1. The **@archetypes/product** Node.js module

**@archetypes/product** is a Node.js [module
...
**@archetypes/product** revisions as [packages
...
**@archetypes/product** uses [`semantic-release`][semantic-release-readme].
...
1.  **Bump the semantic version** of **@archetypes/product** (based on conventional
    commits).
...
1.  **Publish** the **@archetypes/product** to the public npm registry.
...
Open a Terminal and change into your **@archetypes/product** directory.
...
```shell
> archetypes-products@0.0.0 semantic-release /Users/username/Projects/gitlab/archetypes-products/signatures
...
## 3. Installing archetypes-products

```shell
npm install **@archetypes/product** --global
```
...
The only real exception is if **@archetypes/product** is completely unusable by
