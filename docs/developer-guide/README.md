...
> This guide is for those who want to contribute code to **@archetypes/product**.
> This guide describes how to set up your development environment so that you
> can build and test **@archetypes/product**.
...
In order to work with **@archetypes/product** as a developer, we recommend you feel
comfortable with:

| Skill                                                | Reason                                                                                                     |
| ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| ![code][octicon-code] JavaScript                     | **@archetypes/product** is written in JavaScript (CommonJS)                                                   |
...
| ![platform][octicon-server] Node.js                  | **@archetypes/product** runs on Node.js                                                                       |
| ![terminal][octicon-terminal] Command-line-interface | We use the CLI to build, test, and publish **@archetypes/product**                                            |
...
Before you can build and test **@archetypes/product**, you must install and
...
1.  [Git ![link-external][octicon-link-external]](http://git-scm.com)
    ...
    > **@archetypes/product** is hosted on GitLab and uses Git for source control.
...
1.  [Node.js ![link-external][octicon-link-external]](http://nodejs.org),
    ...
    > **@archetypes/product** uses Node.js modules to generate tables of contents,
...
Fork and clone the **@archetypes/product** repository:
...
1.  [**Fork**](https://docs.github.com/ee/gitlab-basics/fork-project.html#how-to-fork-a-project)
    the
    [main **@archetypes/product** repository](https://github.com/archetypes-products/signatures/forks/new)
    (aka, "`origin`").
1.  **Clone _your_ fork** of the **@archetypes/product** repository and define an
    `upstream` remote pointing back to the **@archetypes/product** repository that
    you forked in the first place.

    > ```shell
    > # Clone your GitLab repository:
    > git clone git@github.com:<your-account>/archetypes-products.git
    >
    > # Go to the repo root directory:
    > cd archetypes-products
    >
    > # Add the main GitLab repository as an upstream remote
    > # to your repository:
    > git remote add upstream https://github.com/archetypes-products/signatures.git
    > ```
...
<details><summary><img src="https://cdnjs.cloudflare.com/ajax/libs/octicons/8.3.0/svg/package.svg" height="30" width="30" valign="bottom"> <strong>View current dependencies for archetypes-products...</strong></summary>
...
> ![info][octicon-info] **@archetypes/product** stores configuration details in the
...
SONAR_ORGANIZATION=archetypes-products
SONAR_PROJECT_KEY=signatures
SONAR_PROJECT_NAME=archetypes-products
...
> [![Jest BDD][jest-logo] **@archetypes/product** uses Jest for Behavior-Driven
...
![verified][octicon-verified] **@archetypes/product** uses
...
>
> **@archetypes/product** uses [Travis CI
